...
public class SmartObserverModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        Identifier identifier3 = ModelIds.getBlockSubModelId(ModBlocks.SMART_OBSERVER, "_toggled");
        blockStateModelGenerator.blockStateCollector.accept(VariantsBlockStateSupplier.create(ModBlocks.SMART_OBSERVER).coordinate(createBooleanModelMap(Properties.POWERED, identifier2, identifier)).coordinate(createBooleanModelMap(SmartObserverBlock.TOGGLED, identifier3, identifier)).coordinate(createNorthDefaultRotationStates()));
